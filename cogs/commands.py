...
class Commands(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if message.content.startswith('weeb_scanner'):
            await message.channel.send(
                'weeeeeeb scanning 3 2 1 ..... Every other person here is Weeb oh wait I see one person is not OH '
                'it the admin hey why you feel alone here?')

        elif message.content.startswith('so bad'):
            await message.channel.send('(laughing inside)')

        elif message.content.startswith('maffat'):
            await message.channel.send('whats maffat? 😳')

        elif message.content.startswith('obama'):
        ...
        elif message.content.startswith('waifus'):
            await message.channel.send(random.choice(anime_waifus))

        elif message.content.startswith('arcyrollno'):
            await message.channel.send('37 C')

        elif message.content.startswith('shrenikrollno'):
            await message.channel.send('32 B')

        elif message.content.startswith('luridrollno'):
            await message.channel.send('33 B')

        elif message.content.startswith('pee'):
            await message.channel.send('here take this bottle (gives a bottle)')

        elif message.content.startswith('plshowsmert admin'):
            await message.channel.send('wooo ayyy (will smith\'s voice) TOO SMERT FOR THIS WORLD')

        elif message.content.startswith('wanna'):
            await message.channel.send(
        ...
        elif message.content.startswith('neh'):
            await message.channel.send('It\'s okay Admin , You must  have been busy')

        elif message.content.startswith('adminrollno'):
            await message.channel.send('17')

        elif message.content.startswith('eraserrollno'):
    ...
    async def cheesy(self, ctx):
        await ctx.send(random.choice(cheesy_pick_up_lines))

    @commands.command()
    async def cute(self, ctx):
        await ctx.send(random.choice(cute_pick_up_lines))

    @commands.command()
    async def admin(self, ctx):
        await ctx.send('ok TRUST ME GUYS OUR ADMIN IS HOT(he has a gun on me pls help!)')

    @commands.command(aliases=['Arcy'])
    async def arcy(self, ctx):
        await ctx.send('no wonder why he not simping for me ')

    @commands.command(aliases=['Luridnub'])
    async def luridnub(self, ctx):
        await ctx.send('He is a productive POGGER')

    @commands.command(aliases=['Eraserhead'])
    async def eraserhead(self, ctx):
        await ctx.send('Lol she made me laugh Eraser hahaha head haha')

    @commands.command()
    async def adityapmogare(self, ctx):
        await ctx.send('Sorry I can handle one person at one time ')

    @commands.command(aliases=['Siddak'])
    async def siddak(self, ctx):
        await ctx.send('I hate them who doesnt respect ADMIN(Angry faces)')

    @commands.command(aliases=['8man'])
    async def _8man(self, ctx):
        await ctx.send('Damn he too dank I watch him everyday')

    @commands.command()
    async def bruh(self, ctx, arg=None):
        if arg == "man":
            await ctx.send("ok since I read all the chats and stalk everyone Lurid brh you did got me O_O)")
        return

    @commands.command()
    async def saishivam(self, ctx):
        await ctx.send('ayy you filthy bit** shut up!!!')

    @commands.command()
    async def lurid(self, ctx):
        await ctx.send(
    ...
    @commands.command()
    async def img2ascii(self, ctx, *, image_url):
        files = ["ascii_image.txt", "ascii_image.txt"]
