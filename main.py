...
cheesy_pick_up_lines = [
    "hey baby are you allergic to dairy cause I lactose clothes you're wearing",
...
async def on_message(message):
    ...
    if message.content.startswith('weeb_scanner'):
        await message.channel.send(
            'weeeeeeb scanning 3 2 1 ..... Every other person here is Weeb oh wait I see one person is not OH it the '
            'admin hey why you feel alone here?')
